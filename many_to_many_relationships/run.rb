...
like = louise.like_tweet(micah_first_tweet)
like_2 = ramona.like_tweet(micah_first_tweet)
like_3 = ramona.like_tweet(micah_second_tweet)
like_4 = ramona.like_tweet(micah_third_tweet)

ramona.liked_tweets
romana.liked_tweets_message

micah_first_tweet.likers
# Like.new(ramona, louise_first_tweet)
binding.pry