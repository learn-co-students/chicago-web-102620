...
def num_points_scored(player_name)
  ...
  # return the player's number of points scored
  found_player[:points]
end

def players
  # returns an array of players
  nested_players_array = game_hash.values.map do |team|
    team[:players]
  end
  
  nested_players_array.flatten
end
...
def player_shoe_size(player_name)
  my_players = players
  found_player = find_player(my_players, player_name)
